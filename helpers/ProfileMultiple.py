...
class ProfileMultiple:
    ...
    def export(self) -> None:
        ...
        df = pd.DataFrame(columns = ['con_label','default_CPU', 'default_GPU', 'ttgt_CPU', 'ttgt_GPU', 'tgett_CPU', 'tgett_GPU', 'gett_CPU', 'gett_GPU', 'default_patient_CPU', 'default_patient_GPU', 'cuquantum_CPU', 'cuquantum_GPU', 'tensordot_CPU', 'tensordot_GPU', 'einsum_CPU', 'einsum_GPU', 'cutensor_direct_CPU', 'cutensor_direct_GPU', 'correctness', 'fastest_CPU', 'fastest_GPU', 'speedup_CPU', 'speedup_GPU', 'theory_mem', 'torch_mem'])
